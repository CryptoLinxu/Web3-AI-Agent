...
## 更新摘要
**所做更改**
- 完全更新V3架构设计文档，反映最新的技能系统实现
- 新增详细的12个核心技能模块的职责定义和协作关系
- 更新技能地图V3的可视化流程图和执行规则
- 完善命令约定和模板规范
- 重新设计质量控制机制和门禁式质量控制
...
## 项目结构
技能系统位于skills/x-ray目录，采用"设计稿 + 地图 + 命令约定 + 模板规范 + 单模块技能定义"的结构化组织方式，每个技能模块都有独立的SKILL.md文件定义其职责、输入输出和执行规则。
