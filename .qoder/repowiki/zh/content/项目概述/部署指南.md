...
## 更新摘要
**变更内容**
- 新增生产环境 RLS 升级指南章节，包含服务端 API 删除对话功能
- 新增 Supabase Service Role Key 配置说明
- 更新数据库迁移流程，包含升级生产环境 RLS 的完整步骤
- 新增服务端 API 验证所有权和删除对话的安全机制
- 强化生产环境安全加固内容，包括服务端代理架构建议
...
**章节来源**
- [supabase/migrations/upgrade_production_rls.sql:1-121](file://supabase/migrations/upgrade_production_rls.sql#L1-L121)
...
- [apps/web/.env.example:1-9](file://apps/web/.env.example#L1-L9)
