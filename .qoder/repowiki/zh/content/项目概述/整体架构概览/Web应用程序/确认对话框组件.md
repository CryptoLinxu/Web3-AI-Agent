...
**更新** 新版本引入了紫色主题设计、圆角外观、毛玻璃背景效果，以及增强的Loading状态管理，为用户提供更加现代化和流畅的交互体验。
...
- 危险变体：红色系渐变（`bg-red-600 hover:bg-red-700`）
- 警告变体：黄色系渐变（`bg-yellow-600 hover:bg-yellow-700`）
- 信息变体：紫色系渐变（`bg-purple-600 hover:bg-purple-700`）
