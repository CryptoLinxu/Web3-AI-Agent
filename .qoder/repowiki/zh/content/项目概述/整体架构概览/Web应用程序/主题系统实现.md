...
**更新** 主题提供者现在同时管理`data-theme`属性和`dark`类名，确保与Tailwind CSS的darkMode功能兼容。
...
**章节来源**
- [ThemeSwitcher.tsx:6-42](file://apps/web/components/ThemeSwitcher.tsx#L6-L42)
...
### SSR优化
- 主题提供者在客户端初始化，避免SSR闪烁
- HTML元素类名同步确保服务器渲染的一致性
